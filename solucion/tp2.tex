...
\section{Módulo Juego}
  ...
  \begin{algorithm}[H]{\textbf{iEjecutarAccion}(\In{j}{estr}, \In{a}{accion}, \In{pj}{jugador}) $\to res$ :estr}
    \begin{algorithmic}[1]
      ...
      \State // y me guardo el evento correspondiente a ella
      \State $evtPJ \gets iActualizarPJ(pj,\ a)$                       \Comment $\BigO(|j|)$
      \\
  ...
  \begin{algorithm}[H]{\textbf{iActualizarPJ}(\In{pj}{jugador}, \In{a}{accion}) $\to res:$ evento} \Comment Funcion privada
    \begin{algorithmic}[1]
      ...
      \\
      \State // Devuelvo el evento generado
      \State $res \gets evtPJ$
      \medskip
