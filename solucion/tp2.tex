...
\section{Diccionario Trie ($\alpha$)}
  ...
  \begin{Algoritmos}
    ...
    \begin{algorithm}[H]{\textbf{iVacía}() $\to$ $res$ : dicc($string$, $\alpha$)}
      \begin{algorithmic}[1]
           \State // Reserva la memoria y crea un arreglo estático de 255 posiciones del constructor por defecto de $\alpha$
           \State $res \gets \langle raiz: NULL, \ siguientes: arreglo\_estatico[255] \ de\ \alpha \rangle$ 				\Comment $\Theta(1)$
