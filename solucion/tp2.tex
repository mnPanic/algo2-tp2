...
\section{Módulo Juego}
  ...
  \begin{algorithm}[H]{\textbf{iInfoActualFanEspecial}(\In{j}{estr}) $\to res:$ infoActualFanEspecial}
    \begin{algorithmic}[1]
  ...
  \begin{algorithm}[H]{\textbf{iInfoActualFanVivosQueDisp}(\In{j}{estr}) $\to res:$ infoActualFanEspecial}
    \begin{algorithmic}[1]
      \State $res \gets siguiente(j.infoFantasmaEspecial)$
      \medskip
      \Statex \underline{Complejidad:} $\BigO(1)$
